          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <input
                ...
                style={{ width: '100%', padding: '10px 12px', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 8, color: 'var(--text)', fontSize: 14, fontFamily: 'inherit', transition: 'border-color 0.15s' }}
              />
            </div>
            ...
            <button
              ...
              style={{ width: '100%', padding: '11px', background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 500, fontFamily: 'inherit', cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.7 : 1, transition: 'opacity 0.15s' }}
            >
              {loading ? 'Entrando...' : 'Entrar'}
            </button>
          </form>
